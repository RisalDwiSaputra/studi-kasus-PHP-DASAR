                ...
                <div class="container">
                    <div class="signup-content">
                        <div class="signup-form">
                            ...
                            <form action="proses-edit-reg.php" method="POST" enctype="multipart/form-data">

                                <input type="hidden" name="id" value="<?php echo $siswa['id'] ?>" />    

                                <div class="form-group">
                                    <label for="username"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                    <input type="text" name="username" placeholder="Username anda" value="<?php echo $siswa['username'] ?>" />
                                </div>
                                <div class="form-group">
                                    <label for="password"><i class="zmdi zmdi-lock"></i></label>
                                    <input type="text" name="password" placeholder="password lengkap" value="<?php echo $siswa['password'] ?>" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="nomer_telfon" placeholder="Nomer Anda" value="<?php echo $siswa['nomer_telfon'] ?>" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="ubah_foto" class="label-agree-term"><span><span></span></span>Cek Untuk Mengubah Foto!</label>
                                </div>
