    ...
    <section class="content">
      ...
      <div class="row">
            ...
            <div class="small-box bg-yellow">
                ...
                <p>Data Registrations</p>
                </div>
                <div class="icon">
                <i class="ion ion-person-add"></i>
                </div>
                <a href="tampil.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
            </div>
            <div class="col-lg-6 col-xs-6">
            <?php
            ...
            <div class="small-box bg-aqua">
                <div class="inner">
                <h3><?php echo mysqli_num_rows($qr) ?></h3>
                <p>Feedback</p>
                </div>
                <div class="icon">
                <i class="ion ion-filing"></i>
                </div>
                <a href="data.feedback.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        </div>  
      <!-- /.row -->
            <div class="box box-success">
                ...
                <h3 class="box-title">Feedback Yang Masuk Hari Ini: </h3>
                ...
                <?php
                    $tanggal = date('Y-m-d');
                    $sql = mysqli_query($db, "SELECT * FROM feedback INNER JOIN admin ON feedback.id_siswa = admin.id where tanggal = '$tanggal' ");
