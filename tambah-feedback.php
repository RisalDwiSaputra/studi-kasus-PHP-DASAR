        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form method="POST" action="proses-feedback.php"  data-parsley-validate class="form-horizontal form-label-left">
                        <?php
                            $sql = "SELECT * FROM admin where username = '$_SESSION[user]'";
                            $query = mysqli_query($db, $sql);
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pesan">Pesan Anda</span>
                        </label>
