        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form method="POST" action="proses-reg.php" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                         <input type="hidden" name="user" value="SISWA" class="form-control col-md-7 col-xs-12">
                      </div>
                      <div class="form-group">
                         <label for="upload" class="control-label col-md-3 col-sm-3 col-xs-12">Upload Foto</label>
                         <div class="col-md-6 col-sm-6 col-xs-12">
